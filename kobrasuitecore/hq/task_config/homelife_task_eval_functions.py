"""
------------------Prologue--------------------
File Name: homelife_task_eval_functions.py
Path: kobrasuitecore/kobrasuitecore/task_config/homelife_task_eval_functions.py
...
class HomelifeTaskEvalFunctions:
    pass